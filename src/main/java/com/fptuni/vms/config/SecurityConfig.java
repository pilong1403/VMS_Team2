...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // Cấu hình CSRF: lưu token trong session và expose vào request attributes để Thymeleaf đọc được
        ...
        http
                ...
                // Ghi nhớ URL trước đó để redirect sau đăng nhập (nếu cần)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/home/home").hasAnyAuthority("VOLUNTEER","ADMIN","ORG_OWNER")
