...
public class RegisterController {
    ...
    public String verifyOtp(@RequestParam String email,
        ...
        try {
            ...
            // 4) Đưa flash message (KHÔNG gắn email vào URL)
            redirectAttributes.addFlashAttribute("success",
                    "Registration successful. Please login to continue.");

            // (Optional) nếu muốn prefill email mà không lộ trên URL:
            // redirectAttributes.addFlashAttribute("prefillEmail", created.getEmail());
    ...
    private String mapError(String code) {
        ...
        return switch (code) {
            ...
            // "REGISTER_OK" không còn dùng nữa, có thể bỏ nếu muốn
