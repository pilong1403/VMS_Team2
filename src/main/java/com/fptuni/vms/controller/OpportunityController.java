...
public class OpportunityController {
    ...
    public String save(@Valid @ModelAttribute("form") OpportunityForm form,
        ...
        if (form.getStartDate() != null && form.getStartTime() != null &&
            ...
            if (!end.isAfter(start)) binding.rejectValue("endDate", "invalid", "Ngày/giờ kết thúc phải sau thời điểm bắt đầu");
        }
        ...
        opp.setEndTime(end);
        if (form.getThumbnailUrl() != null) opp.setThumbnailUrl(form.getThumbnailUrl());
    ...
    private String buildCreateMessage(Opportunity opp, Organization org) {
        ...
        sb.append("• Thời gian: ").append(FMT.format(opp.getStartTime())).append(" → ")
                ...
                .append("• Trạng thái: ").append(viStatus().getOrDefault(opp.getStatus().name(), opp.getStatus().name()));
        return sb.toString();
    }
